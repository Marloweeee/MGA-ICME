...
def get_args_parser():
    ...
    parser.add_argument('--bert_model', default=r'checkpoints/bert_base_uncased', type=str, help='bert model')
    ...
    # SALA parameters
    parser.add_argument('--psa_tau',default=0.07, type=float,
                        help='paired sample alignment temperature coefficient')
    parser.add_argument('--csa_tau', default=0.45, type=float,
                        help='cross-modal semantic alignment temperature coefficient')
    parser.add_argument('--ct_tau',default=1.0, type=float,
                        help='cross-modal teacher model soft-label temperature coefficient')
    parser.add_argument('--usa_tau', default=0.45, type=float,
                        help='uni-modal semantic alignment temperature coefficient')
    parser.add_argument('--ut_tau', default=1.0, type=float,
                        help='uni-modal teacher model soft-label temperature coefficient')
    parser.add_argument('--la_tau', default=0.3, type=float,
                        help='localization alignment temperature coefficient')
    parser.add_argument('--alpha', default=5.0, type=float,
                        help='Coefficient of cross-modal semantic alignment')
    parser.add_argument('--beta', default=5.0, type=float,
                        help='Coefficient of uni-modal semantic alignment')
    parser.add_argument('--gama', default=10.0, type=float,
                        help='Coefficient of localization alignment')
    parser.add_argument('--inter_temperature', default=0.5, type=float,
                        help='ptc loss temperature factor')
    parser.add_argument('--intra_temperature', default=0.5, type=float,
                        help='ptc loss temperature factor')
    parser.add_argument('--inter_weight', default=0.5, type=float)
    parser.add_argument('--intra_weight', default=0.1, type=float)
    ...
    parser.add_argument('--disable_channel', action='store_true',
                        help="If true, use amp training")
    parser.add_argument('--swin_checkpoint', default='checkpoints/cascade_mask_rcnn_swin_small_patch4_window7.pth',type=str)
    return parser
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('MGA training script', parents=[get_args_parser()])
